...
public static class EntityTemplates
{
    ...
    /// <summary>
    /// Adds the full physiology stack to <paramref name="entity"/>: metabolism, stomach, energy,
    /// mood, digestive pipeline, and bladder. Uses <see cref="EntityConfig.DefaultHuman"/> when
    /// <paramref name="cfg"/> is null.
    /// Must be called on cast-spawned NPCs so SimulationSnapshot can find them via
    /// Query&lt;MetabolismComponent&gt;().
    /// </summary>
    public static Entity WithPhysiology(Entity entity, EntityConfig? cfg = null)
    {
        cfg ??= EntityConfig.DefaultHuman;
        var m  = cfg.Metabolism;
        var s  = cfg.Stomach;
